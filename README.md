...
For `.rs`, `.py`, `.ts`, `.tsx`, `.js`, `.jsx`, `.go`, and large `.md` files,
read structure with `lupa` before opening full contents. For unsupported
languages, short docs, or known line ranges, use `rg` plus targeted source
slices directly.
